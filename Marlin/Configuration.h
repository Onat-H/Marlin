...
#define STRING_CONFIG_H_AUTHOR "Onat Hekimoglu" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GermanRepRap X400"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 24.00, 24.00 }
    #define DEFAULT_Ki_LIST {  0.88,  0.88 }
    #define DEFAULT_Kd_LIST { 80.00, 80.00 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 66.666667, 66.666667, 2400, 130 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 5, 12 }
